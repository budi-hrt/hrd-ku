...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/editable/css/bootstrap-editable.css">
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue dropdown-modal">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="<?= base_url('assets/images/avatars/' . $user['photo']); ?>" alt="Jason's Photo" />

...
<head>
    ...
    <link href="' . base_url('assets/') . 'css/kanvas.css" rel="stylesheet">
...
<div class="logo" style="text-align: left;margin-left:20px;"><img src="' . base_url('assets/images/logo/logosmall.png') . '"></div>

...
<head>
    ...
    <link href="' . base_url('assets/') . 'css/pdfkanvas.css" rel="stylesheet">
...
<img src="' . base_url('assets/images/logo/ribbon.png') . '">
</div>

<div style="text-align: left;margin-left:20px;"><img src="' . base_url('assets/images/logo/logosmall.png') . '"></div>

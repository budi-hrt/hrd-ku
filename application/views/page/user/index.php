                ...
                <div class="col-xs-12">
                    ...
                    <div class="clearfix">
                        <div class="pull-left alert alert-success no-margin alert-dismissable">
                            ...
                            Klik Foto untuk edit foto profile...
                        </div>
                    </div>
                            ...
                            <div class="col-xs-12 col-sm-3 center">
                                <div>
                                    <span class="profile-picture">
                                        <img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="<?= base_url('assets/images/avatars/' . $user['photo']); ?>" />
                                    </span>
                                    ...
                                    <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
                                        <div class="inline position-relative">
                                            <a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
                                                ...
                                                &nbsp;
                                                <span class="white"><?= $user['nama_user']; ?></span>
                                            </a>
                                ...
                                <div class="profile-user-info profile-user-info-striped">
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            ...
                                            <span class="editable" id="city">Kota Palu</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable" id="signup">01/02/2020</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable" id="about">Jujur, Kreatif</span>
                                        </div>
                                    </div>
                                </div>

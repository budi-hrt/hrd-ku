...
class Gaji_model extends CI_model
{
  ...
  {
    $this->db->select('g.id_gaji,g.gaji_pokok,g.tunjangan,g.um,g.id_kry,k.nama_karyawan,k.jabatan_karyawan,u.username,g.date_update');
    $this->db->from('tb_karyawan k');
    $this->db->join('tb_gaji g', 'g.id_kry=k.id_karyawan', 'dsc');
    $this->db->join('user u', 'u.id_user=g.id_user', 'dsc');
